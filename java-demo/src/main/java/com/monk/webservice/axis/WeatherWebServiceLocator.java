...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements com.monk.webservice.axis.WeatherWebService {
 ...
 */
    ...
    public com.monk.webservice.axis.WeatherWebServiceSoap getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.monk.webservice.axis.WeatherWebServiceSoap getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.monk.webservice.axis.WeatherWebServiceSoapStub _stub = new com.monk.webservice.axis.WeatherWebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.monk.webservice.axis.WeatherWebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.monk.webservice.axis.WeatherWebServiceSoapStub _stub = new com.monk.webservice.axis.WeatherWebServiceSoapStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
