...
public class SmsCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        String[] configUrls = StringUtils.splitByWholeSeparatorPreserveAllTokens(securityProperties.getValidateCode().getSmsCode().getUrls(), ",");
    ...
    private void validaImageCode(ServletWebRequest request) throws ServletRequestBindingException, ValidateCodeException {
        ValidateCode codeInSession = (ValidateCode) sessionStrategy.getAttribute(request, SecurityConstant.SESSION_SMS_CODE_KEY);
